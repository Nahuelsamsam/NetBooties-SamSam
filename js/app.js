...
const platillos = () =>{
    ...
    const ensaladas = platillosArreglo.filter(ensalada=> ensalada.getAttribute('data-platillo') === 'nike');
    const pastas = platillosArreglo.filter(pasta => pasta.getAttribute('data-platillo') === 'adidas');
    const pizzas = platillosArreglo.filter(pizza => pizza.getAttribute('data-platillo') === 'puma');
    const postres = platillosArreglo.filter(postre=> postre.getAttribute('data-platillo') === 'topper');
